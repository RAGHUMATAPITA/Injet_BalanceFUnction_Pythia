...
void Tree_Analyzer_NewNew_Condor(TString input_file, int itxtoutFile, TString out_directory, TString name_of_roorFile)
{
  ...
  if(argc == 5)
    {
      ...
      Tree_Analyzer_NewNew_Condor(inputfile, itxtout, outfile, outfile_name);
    }
  return 0;
}
